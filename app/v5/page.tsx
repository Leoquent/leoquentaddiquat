            ...
            <div className="bg-white text-black font-sans antialiased border-x border-gridline mx-auto max-w-[1920px] relative" style={{ overflowX: 'clip' }}>
                ...
                <nav id="main-nav" className={`fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[1920px] backdrop-blur-sm z-50 flex justify-between items-center px-6 border-b border-gridline transition-all duration-300 ${navScrolled ? 'py-3 bg-white/95 shadow-2xl' : 'py-6 bg-white/90'}`}>
                    <div className="flex items-center gap-2 sm:gap-3 font-sans font-normal text-base sm:text-lg tracking-tighter shrink-0">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-black shrink-0"
                            style={{
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 lg:gap-6 shrink-0">
                        <a href={`${basePath}/v4/`} className="hidden sm:flex items-center gap-2 font-mono text-[10px] border border-gridline px-3 py-1.5 hover:border-lime hover:text-lime transition-colors group">
                            <span className="w-2 h-2 bg-lime group-hover:animate-ping rounded-full"></span>
                            RESTORE SYSTEM
                        </a>
                        <a href="#cta" className="font-mono text-[10px] sm:text-sm border border-gridline px-3 py-1.5 sm:px-4 sm:py-2 hover:border-lime hover:text-lime transition-colors duration-0 uppercase bg-white">
